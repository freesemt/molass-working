...
from _MOLASS.SerialSettings         import get_setting, INTEGRAL_BASELINE
from ElutionCurve           import ElutionCurve
...
from UvBaseSurface          import UvBaseSurface
...
class Absorbance:
    ...
    def compute_integral_basecurve(self):
        from Baseline.Baseline import better_integrative_curve
