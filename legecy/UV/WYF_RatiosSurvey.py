...
def get_wyf_ratios(in_folder, *args, **kwargv):
    from _MOLASS.SerialSettings import clear_temporary_settings, clear_v2_temporary_settings
    from Batch.StandardProcedure import StandardProcedure
    from Batch.LiteBatch import LiteBatch
    from UV.WYF_Ratios import compute_ratios_from_Puv
...
def collect_ratio_data(input_folder, result_folder):
    ...
    from SerialAnalyzer.DataUtils import serial_folder_walk
    global fh
...
if __name__ == '__main__':
    ...
    import KekLib, SerialAnalyzer, DataStructure, GuinierAnalyzer, Decomposer, Extrapolation
    from SerialAnalyzer.DataUtils import get_pytools_folder
