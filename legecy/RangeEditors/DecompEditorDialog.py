...
import os
import logging
from KekLib.OurTkinter import Tk, Dialog, ttk
from KekLib.TkSupplements import set_icon
from KekLib.TkUtils import is_low_resolution
from Decomposer.DecompUtils import CorrectedBaseline
...
class DecompEditorDialog(Dialog):
    def __init__(self, parent, title, sd, mapper, judge_holder, scrollable=False, debug=False):
        ...
        if debug:
            from Mapping.MappingUtils import save_mapped_curves
    ...
    def get_model_list(self):
        ...
        from Models.ElutionCurveModels import EGHA, EMGA
        if enable_edm_model:
            from Models.RateTheory.EDM import EDM
            from Models.Stochastic.Monopore import Monopore
    ...
    def show_reset_from_log_dialog(self):
        from Decomposer.DecompResetDialog import DecompResetDialog
