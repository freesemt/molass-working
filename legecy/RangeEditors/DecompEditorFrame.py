...
from KekLib.TkUtils import split_geometry
from KekLib.OurMatplotlib import get_color, get_hex_color
from _MOLASS.SerialSettings import get_setting, set_setting
from .SuperEditorFrame import SuperEditorFrame
from DataStructure.PeakInfo import PeakInfo
from DataStructure.RangeInfo import DecompEditorInfo, shift_editor_ranges
from DataStructure.AnalysisRangeInfo import AnalysisRangeInfo, convert_to_paired_ranges
from SerialAnalyzer.PairedRangeLogger import log_paired_ranges
from Decomposer.DecompUtils import (
                                    make_range_info_impl,
                                    decompose_elution_better,
                                    )
from Decomposer.UnifiedDecompResult import UnifiedDecompResult
from .DecompSpecPanel import SpecPanel, RANGE_FRAME_HEIGHT
from SerialAnalyzer.DataUtils import compact_path_name
...
class DecompEditorFrame(SuperEditorFrame):
    ...
    def debug_plot(self):
        ...
        from DataStructure.AnalysisRangeInfo import AnalysisRangeInfo
        import Decomposer.DecompEditorDebug
        reload(Decomposer.DecompEditorDebug)
        from Decomposer.DecompEditorDebug import debug_plot_impl
    ...
    def write_residual_amount_to_testerlog(self, y, resid_y):
        from Test.TesterLogger import write_to_tester_log
    ...
    def refresh_figs(self, devel=False):
        if devel:
            from importlib import reload
            import KekLib.TkMplUtils
            reload(KekLib.TkMplUtils)
        from KekLib.TkMplUtils import adjust_the_tkframe_size
        self.draw1()
        self.draw2()
        self.canvas_draw1()
        self.canvas_draw2()
    ...
    def make_range_info(self, concentration_datatype=2, debug=False):
        ...
        if concentration_datatype == 0:       # Xray elution model
            ...
            from Decomposer.OptRecsUtils import eoii_correct_opt_recs
    ...
    def on_mpl_button_press(self, event):
        ...
        if event.button == 3:
            from KekLib.PopupMenuUtils import post_popup_menu
    ...
    def save_the_curves(self):
        ...
        from SerialAnalyzer.CurveSaverDialog import CurveSaverDialog
    ...
    def compute_global_fitting(self):
        ...
        from DataStructure.SvdDenoise import get_denoised_data
