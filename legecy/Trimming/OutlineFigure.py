...
from _MOLASS.SerialSettings import get_setting, get_xray_picking
...
class OutlineFigure(Tk.Frame):
    ...
    def save_the_upper_figure(self):
        ...
        from Trimming.OutlineFigureSaver import save_the_upper_figure_impl
    ...
    def save_the_elution_curve(self, type):
        ...
        import Trimming.OutlineFigureSaver
        reload(Trimming.OutlineFigureSaver)
        from Trimming.OutlineFigureSaver import save_the_elution_curve_impl
