...
from SciPyCookbook import smooth
import DebugPlot as plt
from _MOLASS.SerialSettings import get_setting, get_beamline_name
from Batch.StandardProcedure import StandardProcedure
from Trimming.PreliminaryRecognition import PreliminaryRecognition
from Peaks.EghSupples import egh, compute_AB, d_egh
...
def investigate_diff_effects(in_folder, use_spline=False, fh=None, show_fig=True, fig_file=None, logger=None, uv_file=None, ret_info=False):
    ...
    if use_spline:
        from Trimming.PeakRegion import PeakRegion
