...
from QuickAnalysis.ParammedModel import ParammedModel
...
class AutoRestrictor:
    ...
    def get_better_restriction_impl(self, uv_restrict_list=None, xr_restrict_list=None, debug=False, figfile=None):
        ...
        TODO:
            ...
            from Trimming.PreliminaryRecognition.set_restrict_info
        """
        ...
        if debug or figfile is not None:
            from Trimming.TrimmingDebugUtils import trimming_result_plot
    ...
    def get_them_roughly(self, uv_info, xr_info, debug=False):
        from Peaks.RobustPeaks import RobustPeaks
        from Trimming import get_mapped_info, get_wider_info
    ...
    def get_simple_sigma_points_impl(self, curve, params, peak_top_x, force_ratio=None, debug=False):
        if debug:
            from KekLib.DebugUtils import show_call_stack
        ...
        if debug:
            from Peaks.ElutionModels import egh
