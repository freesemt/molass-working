...
from KekLib.OurTkinter import Tk, Dialog, ttk, ToolTip
...
from Peaks.PeakParamsSet import PeakParamsSet
...
class EditCanvas(Dialog):
    ...
    def body(self, body_frame, devel=True):
        if devel:
            ...
            import KekLib.DraggableCurves
            reload(KekLib.DraggableCurves)
        from KekLib.DraggableCurves import DraggableCurves
    ...
    def adjust_heights(self, debug=False):
        if debug:
            ...
            import QuickAnalysis.ModeledPeaks
            reload(QuickAnalysis.ModeledPeaks)
        from QuickAnalysis.ModeledPeaks import adjust_peak_heights, plot_curve
