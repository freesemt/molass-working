...
from KekLib.KillableThread import Thread
import KekLib.DebugPlot as dplt
...
from QuickAnalysis.PeakUtils import guess_peak_params
...
class PeakEditor(FullBatch, Dialog):
    ...
    def draw_elements(self, uv_peaks, xr_peaks, uv_x, uv_y, xr_x, xr_y, baselines=None, draw_canvas=True):
        ...
        from QuickAnalysis.ModeledPeaks import plot_curve
    ...
    def devel_test(self):
        ...
        from Peaks.PeakDevel import devel_test_impl
