...
from Mapping.MappingV2Utils import make_mapped_info_for_v2
...
class DataTreatment:
    ...
    def get_trimmed_sd(self, sd, pre_recog, debug=False):
        ...
        from Trimming.OptimalTrimming import OptimalTrimming
    ...
    def get_corrected_sd(self, sd, pre_recog, trimmed_sd, debug=False):
        if self._dict["correction"]:
            from Baseline.BaselineUtils import get_corrected_sd_impl
