...
class PairedDataSets:
    def __init__(self, in_folder, kwargs):
        ...
        if lpm_correct:
            from DataStructure.CorrectedData import CorrectedXray, CorrectedUv
            ...
            from DataStructure.RawData import RawXray, RawUv
    ...
    def generate_sample_datasets(self, quad=False, bubble_care=False):
        ...
        if bubble_care:
            ...
            from SerialAnalyzer.AbnormalityCheck import bubble_check_impl
