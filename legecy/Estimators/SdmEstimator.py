...
from Peaks.PeProgressConstants import MAXNUM_STEPS, STOCH_INIT_STEPS
...
class SdmEstimator(BaseEstimator):
    ...
    def compute_sdm_init_params(self, nc_b, lrf_src=None, edm_available=False, debug=False):
        ...
        from Peaks.PeakFronting import has_fronting_peak
    ...
    def get_colparam_bounds_bug(self):
        from Models.Stochastic.DispersiveUtils import NUM_SDMCOL_PARAMS
    ...
    def get_colparam_bounds(self):
        ...
        from Models.Stochastic.ParamLimits import MNP_BOUNDS
