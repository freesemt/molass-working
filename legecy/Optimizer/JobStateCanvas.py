...
from KekLib.OurMatplotlib import NavigationToolbar
...
from KekLib.NumpyUtils import get_proportional_points
from KekLib.BasicUtils import ordinal_str
from KekLib.TimeUtils import friendly_time_str
...
class JobStateCanvas(Tk.Frame):
    ...
    def show_simple_3d_view(self, debug=True):
        ...
        from Tools.SimpleThreedView import show_simple_3d_view
    ...
    def show_sdm_investigator(self, debug=True):
        ...
        from Models.Stochastic.DispersiveUtils import investigate_sdm_params_from_optimizer_params
    ...
    def show_sdm_lrf_investigator(self, debug=True):
        if debug:
            ...
            from importlib import reload
            reload(Models.Stochastic.DispersiveUtils)
        from Models.Stochastic.DispersiveUtils import investigate_sdm_lrf_params_from_optimizer_params
    ...
    def change_view_widths(self):
        ...
        from Trimming.OptViewRange import OptViewRange
        if self.optview_ranges is None:
            optimizer = self.fullopt
            ranges = []
