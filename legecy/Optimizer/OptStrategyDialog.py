...
from Trimming import seem_to_be_manually_trimmed
from KekLib.BraceWidgets import ClosingBrace
from .OptConstants import MIN_NUM_PEAKS, MAX_NUM_PEAKS
from .DefaultNumPeaks import get_default_num_peaks
from Baseline.BaselineUtils import get_default_baseline_type
...
class OptStrategyDialog(Dialog):
    ...
    def show_trimming_figure(self, debug=True):
        ...
        from Trimming.TrimmingResult import TrimmingResultDialog
