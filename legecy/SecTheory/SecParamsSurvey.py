...
def inspect_sec_params(in_folder, *args, **kwargv):
    from _MOLASS.SerialSettings import clear_temporary_settings, clear_v2_temporary_settings, set_setting, get_setting
    ...
    from Tools.EmbedDialog import open_dialog
