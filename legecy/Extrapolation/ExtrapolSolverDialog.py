...
from KekLib.TkUtils import adjusted_geometry
from KekLib.TkSupplements import BlinkingFrame
from KekLib.OurMatplotlib import NavigationToolbar, get_color
...
from SerialAnalyzer.DevSettings import set_dev_setting
...
class ExtrapolSolverDialog( Dialog ):
    ...
    def body( self, body_frame ):
        ...
        if self.scrollable:
            from KekLib.ScrolledFrame import ScrolledFrame
        ...
        from QuickAnalysis.AnalysisGuide import get_data_correction_state_text
    ...
    def save_the_figure( self, folder, analysis_name ):
        from SerialAnalyzer.DataUtils import cut_upper_folders
    ...
    def auto_cdi_for_all(self, out_folder=None):
        ...
        if out_folder is None:
            ...
            if not os.path.exists(out_folder):
                from KekLib.BasicUtils import mkdirs_with_retry
    ...
    def on_drop(self, event, debug=True):
        from SerialAnalyzer.SerialDataUtils import serial_np_loadtxt
        if debug:
