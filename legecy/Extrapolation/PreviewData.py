...
import logging
import numpy as np
from DataStructure.AnalysisRangeInfo import convert_to_paired_ranges, shift_paired_ranges
...
class PreviewData:
    ...
    def __repr__(self):
        from _MOLASS.DummyClasses import DummySd, DummyMapper, DummyJudgeHolder
