...
"""
import os
from KekLib.PersistentPy import PersistentPy, get_py_file_path
try:
    from _MOLASS.Version import get_version_string
except:
    from AutorgKek.AppVersion import get_com_version_string as get_version_string
...
def get_locals_for_settings():
    ...
    from DataStructure.RangeInfo import DecompEditorInfo, RangeEditorInfo
    from DataStructure.AnalysisRangeInfo  import PairedRange
    # from Extrapolation.PreviewData import PreviewData, PreviewOptions
    from Mapping.MappingParams import MappingParams
    from Trimming.TrimmingInfo import TrimmingInfo
    # from Decomposer.ModelEvaluator import ModelEvaluator
    # from Decomposer.DualEvaluator import DualEvaluator
    # from Models.ElutionCurveModels import EGHA, EMGA     # add required models such as STC, EDM, etc. when ready
    # from Models.EGH import EGHA
    from _MOLASS.DummyClasses import (EGHA,
                                     EMGA,
                                     DualEvaluator,
                                     ModelEvaluator,
                                     # TrimmingInfo,
...
def initialize_settings(warn_on_fail=True):
    from AutorgKek.Settings import overriding_init
    from SerialAnalyzer.DevSettings import dev_init
    """
...
RANGE_TYPE_POINTS   = 2     # Boundary Points from Elution No.
UV_BASE_NO          = 0
UV_BASE_CONST       = 1
UV_BASE_STANDARD    = 0
UV_BASE_SHIFTED     = 1
...
def load_settings_dict(file):
    from KekLib.PersistentPy import load_py_file
