...
import time
import warnings
from KekLib.MultiMonitor import get_selected_monitor
from KekLib.EnvironCheck import executables_check
from KekLib.OurMatplotlib import mpl_1_5_backward_compatible_init, mpl_font_init
mpl_1_5_backward_compatible_init()
mpl_font_init()

from KekLib.ExceptionTracebacker import ExceptionTracebacker, log_exception
from KekLib.BasicUtils import mkdirs_with_retry, is_almost_empty_dir
from KekLib.ChangeableLogger import Logger
from KekLib.OurTkinter import Tk, ttk, FileDialog, Font, is_empty_val
from KekLib.TkUtils import adjusted_geometry, PositionSynchronizer
from KekLib.TkSupplements import SlimButton, BlinkingFrame
from KekLib.TkSizableWidgets import SizableLabel, SizableEntry, BlinkingLabel
from KekLib.TkCustomWidgets import FolderEntry, FileEntry
try:
    import KekLib.CustomMessageBox as MessageBox
except:
    import KekLib.OurMessageBox as MessageBox
print( 'import CustomMessageBox ok' )
from KekLib.RecentFolders import RecentFolders
...
from SerialAnalyzer.SerialDataLoader import SerialDataLoader
from SerialAnalyzer.SerialDataUtils import get_uv_filename, get_mtd_filename
from DataStructure.MeasuredData import MeasuredData
from Trimming.OutlineFigure import OutlineFigure
from SerialAnalyzer.AbnormalityCheck import exclude_abnormality
from Trimming.PreliminaryRecognition import PreliminaryRecognition
from QuickAnalysis.Analyzer import Analyzer
from _MOLASS.Version import get_version_string, is_developing_version
from Rank.RankView import RankViewMenu
from GuiParts.UvFolderEntry import UvFolderEntry
from Menus.V2Menu import V2Menu
from _MOLASS.SerialSettings import ( initialize_settings,
                                    get_setting, set_setting, save_settings,
                                    clear_temporary_settings, restore_default_setting,
                                    get_settings_folder )
from SerialAnalyzer.DevSettings import get_dev_setting, set_dev_setting
...
class GuiMain( Tk.Toplevel ):
    def __init__(self, parent, pid=None, debug=0):
        from _MOLASS.Debug import DebugInfo
        dpi_aware = False
        ...
        if dpi_aware:
            from KekLib.DpiAware import set_dpi_aware
            set_dpi_aware()
        ...
        from _MOLASS.AppSingleInstance import single_instance_check
        ...
        if '-i' in sys.argv:
            from _MOLASS.SerialSettings   import clear_settings
            clear_settings()
        ...
        if get_setting('enable_debug_plot'):
            from KekLib.DebugPlot import set_plot_env
            set_plot_env(self)
    ...
    def make_it_more_clever(self):
        from SerialAnalyzer.MakeItMoreClever import increase_menu_availability
    ...
    def show_datarange_dialog( self ):
        from Trimming import DataRangeDialog
    ...
    def on_entry_in_folder( self, refresh=False ):
        ...
        if self.parent_pid is not None:
            from KekLib.CleanerThread import CleanerThread
            ...
            if filename is None:
                ...
                if filename is None:
                    if not self.cleared_uv_folder:
                        ...
                        from _MOLASS.SerialSettings import do_xray_conc_temporary_settings
                    ...
                    from _MOLASS.SerialSettings import do_microfluidic_temporary_settings
    ...
    def analyze_all( self ):
        from SerialAnalyzer.AbnormalityCheck import update_abnormality_fix_state
    ...
    def plot_results( self ):
        print( 'plot_results' )
        from GuinierAnalyzer.SimpleGuinierAnalyzer import SimpleGuinierAnalyzer
        from GuinierAnalyzer.SimpleGuinierFolderAnalyzer import SimpleGuinierFolderAnalyzer
        in_folder = self.in_folder.get()
    ...
    def quit( self, immediately=False ):
        ...
        from _MOLASS.Processes import terminate_all_processes
    ...
    def do_simple_guinier( self, i ):
        ...
        from GuinierAnalyzer.AutorgKekAdapter import AutorgKekAdapter
    ...
    def show_dev_trial_entry(self):
        ...
        from Tools.DevTrial import dev_trial_entry
