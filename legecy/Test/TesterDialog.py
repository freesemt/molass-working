...
from KekLib.OurTkinter import Tk, Dialog, ttk, Font, FileDialog, is_empty_val
from KekLib.TkSupplements import tk_set_icon_portable
...
from KekLib.BasicUtils import get_home_folder
from _MOLASS.SerialSettings import clear_settings, set_setting
from KekLib.MultiMonitor import get_max_monitor
from SerialAnalyzer.DataUtils import get_pytools_folder, get_next_subfolder
...
class TesterDialog( Dialog ):
    ...
    def get_previous_compare_folder( self ):
        ...
        if False:
            ...
            from Test.TesterLogger import get_log_path
