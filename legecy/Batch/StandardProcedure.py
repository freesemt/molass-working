...
from SerialAnalyzer.AbnormalityCheck import bubble_check
...
from Decomposer.DecompUtils import decompose_elution_better, make_range_info_impl
...
class StandardProcedure:
    ...
    def load_old_way(self, folder):
        ...
        from SerialAnalyzer.SerialDataUtils import get_uv_filename
        self.folder = folder
    ...
    def get_sd(self, whole=False, debug=False, set_offsets=True):
        from SerialAnalyzer.SerialData import SerialData
