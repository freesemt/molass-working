...
import re
import numpy as np
from _MOLASS.SerialSettings import get_setting, set_setting, clear_temporary_settings
from Peaks.PeakParamsSet import PeakParamsSet

class FullBatch:
    def __init__(self):
        # to be moved from Peaks.PeakEditor
    ...
    def get_curve_xy(self, return_baselines=False, debug=False):
        ...
        from QuickAnalysis.ModeledPeaks import get_curve_xy_impl
    ...
    def get_modeled_peaks(self, uv_x, uv_y, xr_x, xr_y, num_peaks=None, affine=True, min_area_prop=None, debug=False):
        if debug:
            ...
            from importlib import reload
            reload(QuickAnalysis.ModeledPeaks)
        from QuickAnalysis.ModeledPeaks import get_modeled_peaks_impl
        if num_peaks is None:
    ...
    def get_uv_base_params(self, xyt=None, debug=False):
        ...
        from Baseline.UvBaseline import get_uv_base_params_impl
