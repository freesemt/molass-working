...
import numpy as np
try:
    from KekLib.OurTkinter import Tk, ttk
except:
...
class AdvancedFrame(Tk.LabelFrame):
    def __init__(self, parent, editor, **kwargs):
        from KekLib.SaferSpinbox import SaferSpinbox as Spinbox
    ...
    def estimate_psd(self, devel=True):
        ...
        from Models.Stochastic.TriporeColumn import estimate_psd_impl
    ...
    def estimate_lognormal_psd(self, with_cf=False, devel=True):
        ...
        from Models.Stochastic.LognormalPoreColumn import estimate_lognormal_psd_impl
    ...
    def test_lognormalpore(self, devel=True):
        ...
        from Models.Stochastic.LognormalPore import lognormalpore_test_impl
    ...
    def test_tripore(self, devel=True):
        ...
        from Models.Stochastic.Tripore import tripore_test_impl
    ...
    def test_it(self):
        ...
        import Models.Stochastic.Tripore
        reload(Models.Stochastic.Tripore)
        from Models.Stochastic.Tripore import test_it_from_editor_frame
        print("test it")
