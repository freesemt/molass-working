...
from ElutionCurve           import ElutionCurve, PEAK_INFO_FIND_RATIO
from Elution.CurveUtils      import get_probably_corresponding_index
from _MOLASS.SerialSettings         import ( get_setting, reset_setting, set_setting,
...
from ExceptionTracebacker   import ExceptionTracebacker, log_exception
...
from UV.XrayProportional import make_proportional_mapping_info_impl
...
class ElutionMapper:
    ...
    def make_a_curve(self, opt_params, helper_info=None, flow_change_exist=False, devel=True):
        ...
        if uv_baseline_opt == 0:
            ...
            if uv_baseline_type == 1:
                ...
                if self.enable_lrf_baseline:
                    ...
                    from Trimming.UvBaseSolver import get_lrf_elution_base
                    try:
        ...
        if debug:
            from CanvasDialog   import CanvasDialog
            from ElutionCurve   import proof_plot
    ...
    def compute_xray_baseline(self, opt_params):
        ...
        if with_bpa:
            from Baseline.LambertBeer import get_standard_baseline
