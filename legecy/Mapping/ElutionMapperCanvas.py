...
from KekLib.OurTkinter import Tk, Dialog
import KekLib.CustomMessageBox as MessageBox
from KekLib.TkUtils import is_low_resolution
from KekLib.BasicUtils import get_caller_module
from KekLib.TkSupplements import tk_set_icon_portable, BlinkingFrame
from QuickAnalysis.AnalysisGuide import get_analysis_guide_info
from _MOLASS.SerialSettings import get_setting, set_setting, get_xray_picking
from UV.PlainCurveUtils import get_flat_wavelength
from SerialAnalyzer.AnalyzerUtil import get_init_ranges
from DataStructure.AnalysisRangeInfo import set_default_analysis_range_info
...
from _MOLASS.Version import is_developing_version
...
class ElutionMapperCanvas(Dialog):
    ...
    def show_scattering_figure( self ):
        ...
        if USE_NEW_3D_PLOT_CLASS:
            from SerialAnalyzer.Scattering3dPlot   import Scattering3dPlotDialog
            ...
            if ENABLE_SIMULATION or get_setting('enable_drift_simulation') == 1:
                if self.three_d_guide:
                    from SerialAnalyzer.DriftSimulation import DriftSimulation
                    from SerialAnalyzer.DriftAnalyzer import create_mapper_for_drift_analysis
            ...
            from SerialAnalyzer.ScatteringPlot import ScatteringPlot
    ...
    def show_absorbance_viewer( self ):
        from UV.AbsorbanceViewer import AbsorbanceViewer
    ...
    def investigate_correction( self ):
        ...
        from SerialAnalyzer.ScatteringBaseCorrector import ScatteringBaseCorrector
        ...
        from SerialAnalyzer.ScatteringBaseInvestigator import InvestigatorDialog
    ...
    def debug_sd(self):
        from DataStructure.MdViewer import MdViewer
        sd = self.serial_data
    ...
    def auto_navigate_to_decomp_editor( self ):
        ...
        def show_progress():
            ...
            from KekLib.ProgressMinDialog import ProgressMinDialog
            counter[0] += 1
            for k in range(3):
                try:
    ...
    def do_devel_test(self):
        ...
        from Tools.EmbedCushion import embed_cushion
