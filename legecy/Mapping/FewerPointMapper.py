...
from Peaks.RobustCurve import RobustCurve, plot_curve, gaussian
from Trimming.MatchingPeaks import compute_matching_indeces
...
def demo(sd, peak_model_class, scale_mapped=True):
    ...
    from Peaks.RobustCurve import LIFTED_BASE, MINIMIZE_METHOD
