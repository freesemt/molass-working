...
from KekLib.RunPython import run_this_python
...
def install_jupyterlab(parent=None):
    ...
    import sys
    import psutil
    from KekLib.TkCustomWidgets import MessageBox
    ...
    if parent is None:
        ...
        from KekLib.RunPython import run_this_python_stdout_lines
        from KekLib.ProgressMinDialog import run_with_progress
