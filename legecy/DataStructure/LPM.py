...
from SerialAnalyzer.BasePercentileOffset import base_percentile_offset
from KekLib.SciPyCookbook import smooth
from MatrixData import simple_plot_3d
from SerialAnalyzer.ElutionBaseCurve import ElutionBaseCurve
from Baseline.LambertBeer import BasePlane
from Baseline.BaseScattering import get_baseplane
...
class LPM_3d:
    def __init__(self, data, ecurve_y=None, smoothing=True, integral=False, for_all_q=True, e_index=None, end_slices=None, debug=False):
        ...
        if integral:
            from Baseline.Baseline import integrative_curve
            smoothing = False
