...
from GuinierAnalyzer.SimpleGuinier import QUALITY_BOUNDARY_QRG
from GuinierAnalyzer.AutorgKekAdapter import AutorgKekAdapter
from Test.Tester import compare_tester_rg
