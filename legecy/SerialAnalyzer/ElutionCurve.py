...
from Elution.CurveUtils import proof_plot, simple_plot
...
from Irregular.Preprocess import correct_flat_negative_baseline
...
class ElutionCurve:
    def __init__( self, y,
        ...
        if debug_plot:
            from KekLib.DebugPlot import get_parent
    ...
    def get_emg_peaks(self, **kwargs):
        if self.emg_peaks is None:
            ...
            from DataStructure.EmgPeak import get_peaks
    ...
    def get_end_points(self, debug=False):
        from KekLib.GeometryUtils import rotate
        x = self.x
        y = self.y
