...
from _MOLASS.SerialSettings         import get_setting, set_setting, ITEM_DEFAULTS
...
class SpecialistOptionsDialog( Dialog ):
    ...
    def body( self, body_frame ):   # overrides parent class method
        ...
        # enable Decomposition from UV-Xray separation
        grid_row += 1
        self.decomp_from_separation = Tk.IntVar()
        self.decomp_from_separation.set( get_setting( 'decomp_from_separation' ) )

        cb = Tk.Checkbutton( iframe, text="enable Decomposition from UV-Xray separation",
