...
from _MOLASS.SerialSettings         import get_setting, get_xray_picking, XARY_BASE_LINEAR, XARY_BASE_QUADRATIC, XARY_BASE_SPLINED
from ElutionBaseCurve       import ElutionBaseCurve
...
def compute_baseline_using_LPM_impl(baseline_type, num_iterations, i, y, p_final=None, k=None, curve=None, logger=None, suppress_log=True, debug=False):
    ...
    """
    from Baseline.Baseline import LPM_PERCENTILE, integrative_curve, better_integrative_curve
...
class ScatteringBaseCorrector:
    ...
    def correct_with_matrix_base( self, mapped_info, progress_cb=None, return_base=False ):
        from Baseline.BaseScattering import basescattering_correct
