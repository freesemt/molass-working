...
class ScaledDataDialog(Dialog):
    ...
    def on_in_folder_entry(self):
        ...
        try:
            ...
            from ExceptionTracebacker import log_exception
    ...
    def set_data(self, data_array):
        from Elution.CurveUtils import get_xray_elution_vector
        from ElutionCurve import ElutionCurve
    ...
    def get_range_info(self):
        from Trimming.PreliminaryRg import PreliminaryRg
        from Trimming.FlangeLimit import FlangeLimit
        from Trimming.GuinierLimit import GuinierLimit
