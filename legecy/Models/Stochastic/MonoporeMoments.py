...
from Models.Stochastic.ParamLimits import USE_K, M1_WEIGHT, M2_WEIGHT, BASINHOPPING_SCALE, MonoporeParamsScaler
...
def study_monopore_moments_impl(lrf_src,
    ...
    from Models.Stochastic.MonoporeUtils import guess_monopore_colparams
    from Models.Stochastic.ExclusionCurves import compute_simply_conformant_rgs
