...
from Models.Stochastic.ParamLimits import USE_K, M1_WEIGHT, M2_WEIGHT, PORESIZE_BOUNDS, BASINHOPPING_SCALE, N0_INIT, OligoporeParamsScaler
from Models.Stochastic.OligoporeImpl import USE_DISPERSIVE, oligopore_pdf
...
def study_oligopore_moments_impl(lrf_src,
    ...
    if debug:
        ...
        reload(module)
    from Models.Stochastic.OligoporeUtils import guess_oligopore_colparams, plot_oligopore_conformance
    ...
    def plp_scales_objective(p, return_cy_list=False, title=None):
        ...
        if debug:
            def plot_details():
                ...
                from Models.Stochastic.OligoporeUtils import plot_oligopore_moments_state
