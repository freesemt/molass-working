...
from Models.Stochastic.MonoporeUtils import compute_monopore_curves, plot_monopore_curves, adjust_scales_to_egh_params_array
...
def guess_monopore_params_roughtly(x, y, model, peaks, peak_rgs, props, egh_moments_list, debug=False):
    ...
    if False:
        from Models.ModelUtils import data_dump
