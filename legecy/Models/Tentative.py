...
from Models.ElutionModelUtils import get_xies_from_height_ratio
...
class Model:
    ...
    def guess_multiple(self, x, y, num_peaks, debug=False):
        ...
        from QuickAnalysis.ModeledPeaks import recognize_peaks  # placed here to avoid circular import
