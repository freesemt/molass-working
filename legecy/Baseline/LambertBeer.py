...
from KekLib.ThreeDimUtils import compute_plane
...
class BasePlane:
    def __init__(self, data, index, ecurve, denoise=False, rank=None, j0=0, debug=True):
        ...
        if debug:
            from DataStructure.MatrixData import simple_plot_3d, contour_plot
    ...
    def objective(self, params):
        ...
        if False:
            from DataStructure.ModeledData import simple_plot_3d
            print('params=', (a, b, c))
