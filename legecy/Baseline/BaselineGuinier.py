...
from _MOLASS.SerialSettings import get_setting, set_setting, INTEGRAL_BASELINE, restore_default_setting
...
class BaselineGuinier:
    def __init__(self, D, E, q, i_index, e_slice, end_slices=None):
        from DataStructure.LPM import LPM_3d      # moved due to ImportError: cannot import name 'LPM_3d' from partially initialized module 'LPM' (most likely due to a circular import) 
