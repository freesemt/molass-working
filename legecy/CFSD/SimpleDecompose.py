...
from Models.Characteristic import CfSpace
from Decomposer.FitRecord import FitRecord
...
from Models.CfsEvalPeaks import CFSE_WEIGHT
...
def decompose_elution_simply(x, y, uv_y, model, traditional_info, props=None, using_cfs=False, debug=False):
    ...
    if debug:
        from Decomposer.OptRecsUtils import compute_area_proportions
