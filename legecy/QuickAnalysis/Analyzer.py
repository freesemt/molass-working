...
"""
import os
from KekLib.BasicUtils import exe_name, clear_dirs_with_retry
...
from SerialAnalyzer.DevSettings import get_dev_setting
from QuickAnalysis.JudgeHolder import JudgeHolder

SD_DEBUG = False
if SD_DEBUG:
    from SerialAnalyzer.SdDebugger import SdDebugger
...
class Analyzer:
    ...
    def do_analysis(self, sd, pre_recog, md, analysis_folder, analysis_name, devel=False):
        ...
        from KekLib.ReadOnlyText import ReadOnlyText
        from SerialAnalyzer.ProgressInfoUtil import estimate_init_max_dist
        from KekLib.ProgressInfo import ProgressInfo
        from KekLib.ProgressInfoDialog import ProgressInfoDialog
        import Extrapolation
        from .AnalyzerDialogProxy import AnalyzerDialogProxy
        from SerialAnalyzer.InputOutputDisplay import InputOutputDisplay
        from SerialAnalyzer.AnalyzerUtil import compute_conc_factor_util
        from Mapping.MapperConstructor import create_mapper        
        from Mapping.ElutionMapperCanvas import ElutionMapperCanvas
    ...
    def start_controller( self, serial_data, range_type, analysis_ranges, preview_params, min_value, zx_flag, mapped_info ):
        # delayed imports to reduce initial load time
        from SerialAnalyzer.SerialControlInfo import SerialControlInfo
        from SerialAnalyzer.SerialController import SerialController
