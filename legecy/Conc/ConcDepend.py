...
from _MOLASS.SerialSettings import get_xray_picking
...
def compute_distinct_cd(M, C, cd_slice, scale, logger):
    from QuickAnalysis.JudgeHolder import convert_to_degrees
    try:
...
class ConcDepend:
    ...
    def compute_rdr_legacy(self, M, E, P1, A1, A2):
        from QuickAnalysis.RgDiffRatios import compute_rdr_legacy_impl
