...
def dev_trial_entry(caller):
   ...
   def prepare_data():
      ...
      from Trimming.MomentTrimming import set_moment_trimming_info
   ...
   def spike_test():
      ...
      from Models.MomentFitting import spike
      spike(caller)
   ...
   def opt_view_range():
      ...
      from Trimming.OptViewRange import get_opt_view_range
