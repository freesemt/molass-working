...
def embed_cushion_impl_UnifiedDecompResultTest(caller):
    ...
    from Decomposer.UnifiedDecompResultTest import unit_test
    unit_test(caller)
...
def embed_cushion_impl_(caller):
    ...
    from Tools.EmbedCushionUtils import get_caller_attr
    ...
    if gi_sd is None:
        from Tools.SdUtils import get_sd
...
def embed_cushion_impl_EdmParamInspect(caller):
    ...
    from Models.RateTheory.EdmParamInspect import demo
...
def embed_cushion_impl_Models(caller):
    ...
    from Models.ElutionModelDemo import demo
...
def embed_cushion_impl_DispersiveUtils(caller):
    ...
    from Models.Stochastic.DispersiveUtils import investigate_sdm_params_from_v2_result
